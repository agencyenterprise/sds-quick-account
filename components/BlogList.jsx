          ...
          <div className="md:flex md:justify-between">
            ...
            <div className="md:grow -mt-4">
              ...
              <article className="flex items-center py-4 border-b border-gray-200">
                <div>
                  <header>
                    <h2 className="h4 mb-2 hover:underline">
                      <Link href="/blog-post">
                        <span>Create and Deploy a blog with Simple</span>
                      </Link>
                    </h2>
                  </header>
                  <div className="text-lg text-gray-600 mb-4">
                    In this post, you will learn how to deploy a blog using
                    Simple custom asset source plugin that uses the webcam to
                    insert a photo in the image field.
                  </div>
              ...
              <article className="flex items-center py-4 border-b border-gray-200">
                <div>
                  <header>
                    <h2 className="h4 mb-2 hover:underline">
                      <Link href="/blog-post">
                        How to work with friendly APIs
                      </Link>
                    </h2>
                  </header>
                  <div className="text-lg text-gray-600 mb-4">
              ...
              <article className="flex items-center py-4 border-b border-gray-200">
                <div>
                  <header>
                    <h2 className="h4 mb-2 hover:underline">
                      <Link href="/blog-post">
                        Community Digest: Summer Edition
                      </Link>
                    </h2>
                  </header>
                  <div className="text-lg text-gray-600 mb-4">
              ...
              <div>
                ...
                <ul className="-my-2">
                  <li className="flex py-2 border-b border-gray-200">
                    ...
                    <div className="hover:underline font-medium mb-1">
