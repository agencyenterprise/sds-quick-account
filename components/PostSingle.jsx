                ...
                <div>
                  ...
                  <div className="text-lg text-gray-600">
                    ...
                    <p className="mb-8">
                      ...
                      risus nec feugiat auctor urna nunc id cursus metus aliquam
                      eleifend, arcu dictum varius duis at consectetur lorem
                      donec massa sapien, sed risus ultricies tristique nulla
                      aliquet. Morbi tristique senectus et netus et, nibh nisl
                    ...
                    <p className="mb-8">
                      ...
                      >
                        ...
                        <svg
                          className="w-3 h-3 fill-current text-blue-400 shrink-0 ml-2"
                          viewBox="0 0 12 12"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                    ...
                    <p className="mb-8">
                      ...
                      sapien, sed risus ultricies tristique nulla aliquet.
                    </p>
                    <h4 className="h4 text-gray-900 mb-4">
                    ...
                    <blockquote className="italic text-gray-900 font-medium mb-8">
                      ...
                      nunc eget lorem dolor sed viverra. Semper auctor neque
                    ...
                    <p className="p-4 bg-gray-100 border border-gray-300 rounded mb-8">
                      ...
                      is a sed viverra ipsum nunc aliquet bibendum enim eu augue
                      ut lectus arcu bibendum at. Non sodales neque sodales ut
                      etiam sit. Venenatis urna cursus eget nunc scelerisque
                      viverra mauris in aliquam. Learn more{" "}
                      <a className="text-gray-900 underline" href="#0">
                        here
                      </a>
                      .
                    ...
                    <p className="mb-8">
                      Aenean sed adipiscing diam donec adipiscing tristique
                      risus nec feugiat auctor urna nunc id cursus metus aliqu
                    </p>
                    <p className="mb-8">
                      <strong className="font-medium text-gray-900">
                    ...
                    <p>
                      ...
                      telluse nim ut tellus elementum sagittis vitae et leo duis
                      egestas purus viverra accumsan in nisl nisi scelerisquep
                      ellentesque habitant morbi tristique, senectus et netus et
                      dolor purus non enim praesent elementum facilisis leol,
                      aoreet suspendisse interdum consectetur libero id
                      faucibus.
                    </p>
