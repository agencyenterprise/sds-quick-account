            ...
            <div className="max-w-sm md:max-w-2xl xl:max-w-none mx-auto grid gap-8 md:grid-cols-2 xl:grid-cols-4 xl:gap-6 items-start">
                  ...
                  <form action="/api/payment/checkout_sessions" method="POST">
                    <section>
                      ...
                      <input
                        type="text"
                        name="amount"
                        defaultValue={priceOutput.plan2[value][1]}
                      />
                    </section>
                  </form>
                </div>
                  ...
                  <form action="/api/payment/checkout_sessions" method="POST">
                    <section>
                      ...
                      <input
                        type="text"
                        name="amount"
                        defaultValue={priceOutput.plan3[value][1]}
                      />
                    </section>
                  </form>
                </div>
              ...
              >
                <div className="mb-4">
                  ...
                  <div className="inline-flex items-baseline mb-2">
                    <span className="text-3xl font-bold">
                      {priceOutput.plan4[value][0]}
                    </span>
                    <span className="text-4xl font-bold">
                      {priceOutput.plan4[value][1]}
                    </span>
                    <span className="text-gray-600 pl-2">
                      {priceOutput.plan4[value][2]}
                    </span>
                  </div>
                  <div className="text-lg text-gray-800">
                    For larger teams that need to create, and collaborate.
                  ...
                  <form action="/api/payment/checkout_sessions" method="POST">
                    <section>
                      ...
                      <input
                        type="text"
                        name="amount"
                        defaultValue={priceOutput.plan4[value][1]}
                      />
                    </section>
                  </form>
                </div>
